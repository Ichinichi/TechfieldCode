...
public class main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Dataset<Row> responses = dataFrameReader.option("header","true").csv("s3n://s3-us-west-2.amazonaws.com/stackoverflowbucket6969/2016StackOverflowSurveyResponses.csv");
